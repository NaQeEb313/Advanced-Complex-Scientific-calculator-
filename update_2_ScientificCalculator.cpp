...
public:
    void set1data(double p, double q)
    {
        a = p;
        b = q;
    }
...
public:
    ...
    friend float dot_product(point p1, point p2);
    friend point cross_product(point p1, point p2);
};
...
float dot_product(point p1, point p2)
{
    ...
    {
        cout << "Error: Dimension mismatch! Cannot calculate dot product." << endl;
        return NAN;
    }
...
point cross_product(point p1, point p2)
{
    ...
    {
        cout << "Error: Cross product is only defined for 3-dimensional vectors." << endl;
        result.dimension = 0;
        result.d = nullptr;
        return result;
    }
    ...
    result.d[0] = p1.d[1] * p2.d[2] - p1.d[2] * p2.d[1];
    result.d[1] = p1.d[2] * p2.d[0] - p1.d[0] * p2.d[2];
    result.d[2] = p1.d[0] * p2.d[1] - p1.d[1] * p2.d[0];
...
int main()
{
    ...
    case 1:
    {
        ...
        {
        case 1:
            cout << "Result: " << calc.sum() << endl;
            break;
        case 2:
            cout << "Result: " << calc.diff() << endl;
            break;
        case 3:
            cout << "Result: " << calc.product() << endl;
            break;
        case 4:
    ...
    case 2:
    {
        ...
        case 1:
            ...
            break;
        case 2:
            cout << "Result: " << calc.sin_func() << endl;
            break;
        case 3:
            cout << "Result: " << calc.cos_func() << endl;
            break;
        case 4:
            cout << "Result: " << calc.tan_func() << endl;
            break;
        case 5:
            cout << "Result: " << calc.cosec() << endl;
            break;
        case 6:
            cout << "Result: " << calc.sec() << endl;
            break;
        case 7:
            cout << "Result: " << calc.cot() << endl;
            break;
        case 8:
            cout << "Result: " << calc.ln() << endl;
            break;
        case 9:
            cout << "Result: " << calc.loga() << endl;
            break;
        case 10:
            cout << "Result: " << calc.arcsin_func() << endl;
            break;
        case 11:
            cout << "Result: " << calc.arccos_func() << endl;
            break;
        case 12:
            cout << "Result: " << calc.arctan_func() << endl;
            break;
        case 13:
            cout << "Result: " << calc.arccosec_func() << endl;
            break;
        case 14:
            cout << "Result: " << calc.arcsec_func() << endl;
            break;
        case 15:
            cout << "Result: " << calc.arccot_func() << endl;
            break;
        default:
            cout << "Invalid choice." << endl;
        }
    ...
    case 3:
    {
        ...
        {
        case 1:
            result = comp_sum(c1, c2);
            result.display();
            break;
        case 2:
            result = comp_diff(c1, c2);
            result.display();
            break;
        case 3:
            result = comp_product(c1, c2);
            result.display();
            break;
        case 4:
            result = conjugate(c1);
        ...
        case 6:
            ...
            break;
        case 7:
            cout << "Magnitude: " << comp_magnitude(c1) << endl;
            break;
        case 8:
            cout << "Argument (in radians): " << comp_argument(c1) << endl;
            break;
        default:
            cout << "Invalid choice." << endl;
        }
    ...
    case 4:
    {
        ...
        cout << "Enter:" << endl
             ...
             << "6 for dot product" << endl
             << "7 for cross product (only 3D)" << endl;
        ...
        case 7:
            ...
            {
                cout << "Error: Cross product only defined for 3D vectors." << endl;
            }
            else
            {
                point result = cross_product(A, B);
                cout << "Cross Product: ";
                result.getdata();
            }
            break;
